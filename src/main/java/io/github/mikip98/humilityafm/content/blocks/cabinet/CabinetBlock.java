...
public class CabinetBlock extends HorizontalFacingBlock implements Waterloggable, BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        playCabinetSound(player, world, pos);
        return ActionResult.SUCCESS;
    }
    protected void playCabinetSound(@Nullable Entity source, World world, BlockPos pos) {
        SoundUtils.playSoundAtBlockCenter(source, world, pos, SoundEvents.BLOCK_BAMBOO_BREAK, 0.35f);
    }
