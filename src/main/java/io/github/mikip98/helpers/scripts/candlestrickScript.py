...
def generateNames():
    ...
    for metalType in metalTypes:
        ...
        for woolType in vanilla_wool_types:
            cabinetBlockVariantsNames.append("candlestick_" + metalType + "_" + woolType)
        ...
        JSON = """
{
    ...
    "textures": {
        ...
        for woolType in vanilla_wool_types:
            JSON = """
{
    "parent": "block/candlestick_candle",
    "textures": {
        "0": "block/""" + metalType + """_block",
        ...
        "particle": "block/""" + metalType + """_block"
            ...
            with open("src/main/resources/assets/humility-afm/models/block/candlestick_" + metalType + "_" + woolType + ".json", "w") as file:
                file.write(JSON)
